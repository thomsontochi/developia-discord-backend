...
// Prop to receive the existing category
...
const imagePreview = ref(props.category.image_path || props.category.image_url || null);
const fileInput = ref(null);

// Input sanitization (same as create form)
...
// Form validation (similar to create form)
const validateForm = () => {
    const errors = {};
